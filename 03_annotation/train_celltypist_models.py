...
# ----------------------------
# Input roots — override via environment variables
...
# Output directory for CellTypist models
MODEL_DIR = os.getenv("MODEL_DIR", "/datos/home/mdiaz/.celltypist/data/models")
...
# Training params
TOP_GENES = int(os.getenv("TOP_GENES", "300"))
USE_SGD = os.getenv("USE_SGD", "false").lower() == "true"
N_JOBS_DEFAULT = int(os.getenv("N_JOBS", "32"))
