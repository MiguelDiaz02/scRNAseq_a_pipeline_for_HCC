...
# Load HCC samples
# ----------------------------------------------------------------------
adatas = [x for x in os.listdir('/home/mdiaz/sc_liver_data/hcc_h5ad_adata') if x.endswith('.h5ad')]

def load_it(adata):
    """Load one HCC AnnData file and standardize metadata fields."""
    samp = adata.split('_')[0]
    dx = adata.split('_')[1]
    adata = sc.read_h5ad('/home/mdiaz/sc_liver_data/hcc_h5ad_adata/' + adata)
...
adata.raw = adata.copy()
adata.write('/home/mdiaz/HCC_project/hcc_adata/0C_doub_remov.h5ad')
