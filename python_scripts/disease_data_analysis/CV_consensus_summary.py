...
Author: ChatGPT (for Miguel)

Usage:
  python consensus_cv_summary.py \
      --cv_outdir /home/mdiaz/HCC_project/HCC_analysis/Diseased_CV_2sc \
      --export_prefix DiseasedCV_ \
      --unknown_policy auto \
      --collect_pred_scores true

unknown_policy: auto | excl | incl
  - auto: intenta 'canonical', luego *_exclUnknown, luego *_inclUnknown
  - excl: prioriza *_exclUnknown
  - incl: prioriza *_inclUnknown
"""
...
def parse_args():
    ...
    p.add_argument("--cv_outdir", required=True, help="Directory containing fold*_DiseasedCV/ etc.")
    p.add_argument("--export_prefix", default="DiseasedCV_", help="Prefix for output file names.")
