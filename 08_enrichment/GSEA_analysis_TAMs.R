...
out_path <- "/home/mdiaz/HCC_project/MERGED_analysis/GSEA_results/tams" # output path, where you want your results exported to
...
# Read in data ===================================================
list.files(in_path)
df <- read.csv(paste0(in_path, '/TAMs_vs_Macrophages.csv'))
...
#SAVING PLOTS####
#################
output_dir <- "/home/mdiaz/HCC_project/MERGED_analysis/GSEA_results/tams"
save_plot <- function(plot_expr, filename, width=10, height=8, path="/home/mdiaz/HCC_project/MERGED_analysis/GSEA_results/tams") {
