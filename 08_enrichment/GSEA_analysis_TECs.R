...
out_path <- "/home/mdiaz/HCC_project/MERGED_analysis/GSEA_results/tecs" # output path, where you want your results exported to
...
# Read in data ===================================================
list.files(in_path)
df <- read.csv(paste0(in_path, '/TECs_vs_Endothelial_cells.csv'))
...
#SAVING PLOTS####
#################
output_dir <- "/home/mdiaz/HCC_project/MERGED_analysis/GSEA_results/tecs"
save_plot <- function(plot_expr, filename, width=10, height=8, path="/home/mdiaz/HCC_project/MERGED_analysis/GSEA_results/tecs") {
