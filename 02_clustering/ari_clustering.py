...
Configuration defaults can be overridden via environment variables:
  ...
  OUTPUT_DIR    — output directory for all result files
"""
...
INPUT_H5AD = os.getenv(
    'INPUT_H5AD',
    '/home/mdiaz/HCC_project/hcc_adata/1_5T_unintegrated_CellTypeFromPred.h5ad'
)
...
def ari_by(ad, group_col, ref_col, clu_col):
    """Compute per-group ARI between reference labels and cluster assignments."""
    rows = []
...
def main():
    ...
    ap.add_argument("--input", default=INPUT_H5AD, help=".h5ad file with counts layer and labels")
